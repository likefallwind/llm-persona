...
Snapshot: 2026-08-20. Sources below are official ACL Anthology records or the
...
| Persona consistency (Findings EMNLP 2025) | Assigned personas across survey, essay, social-post, and dialogue tasks | Persona consistency varies by persona, task structure, context, and model design | Directly owns cross-task consistency for prompted personas; we study unassigned educational defaults with generic-domain and external-criterion falsifiers |
| ScaffoldLM / MHPO (ACL 2026) | Learner-state planning and trajectory-level policy optimization | Structured memory and multi-horizon rewards can improve desired tutoring behavior | Control methods rather than construct-validity audits of naturally recurring multi-model defaults |
...
| Helpfulness-as-pedagogy audit (arXiv 2026) | 1,179 confirmatory tutor turns, three bases, two frozen judges, deterministic answer-leakage and independent-work measures | General helpfulness is judge-contingent and not a reliable pedagogy signal | Directly owns this measurement warning; our distinct contribution is cross-task default-policy construct validity with human actions, human-gold diagnosis, and a factorial detector audit |
| Socratic withholding supervisor (arXiv 2026) | Deployed policy core, deterministic detector, LLM judge, scripted-persona calibration | A machine-checkable help ceiling can enforce answer withholding without claiming learning gain | Control architecture, not comparative default-policy measurement; precludes a first deployed-withholding claim |
...
- [Reusens et al., 2025](https://aclanthology.org/2025.findings-emnlp.603/)
- [ScaffoldLM, 2026](https://aclanthology.org/2026.acl-long.325/)
- [MHPO, 2026](https://aclanthology.org/2026.acl-long.518/)
