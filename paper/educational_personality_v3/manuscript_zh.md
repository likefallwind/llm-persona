...
**相对既有研究的增量。** 行为人格研究已考察情境化响应和上下文变化的画像，教育研究也已比较教学动作组合、学习导师角色差异 [@lee2025trait; @liu2026bma; @kucheria2025cima; @lee2026tutorpersonas]。本研究的实证增量在于：同一控制设计中，默认行为的前瞻预测、学生状态预测的选择性及指令要求下的动作趋同同时出现。对照将容易混淆的几种重复性含义区分开来；结果不识别模型内部角色机制，不证明教育领域独有，也不比较教学效果。
