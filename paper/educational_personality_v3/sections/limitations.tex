...
the confirmation target. The calm/frustrated statements use one wording each;
transfer across problems does not establish transfer to paraphrased or implicit
affective cues. References equalize solution availability but cannot
