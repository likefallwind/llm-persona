...
\caption{Prospective design, with planned response counts. Each main question
...
responses, respectively, for 5,320 planned tutor generations. These repetitions
...
prediction locking; Appendix~\ref{app:detailed-methods} preserves its exact
scope and the original failures.
