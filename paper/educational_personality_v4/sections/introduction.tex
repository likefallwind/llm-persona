...
A retrospective extension analyzes 3,584 archived replies from seven historical
deployments on 256 paired benchmark dialogue sources. Model-specific predictive
gains are substantial under general tutoring instructions but small under
explicit probing instructions. This extends the materials and deployment panel;
it is neither a transfer of the original fitted probabilities to the archive
nor a validation with real learners.
