...
and permits follow-up reasoning. All models give the answer under EXPLAIN, yet
reasoning invitations range from 1.6\% to 62.5\%. Actions may co-occur; these frequencies
...
models invite reasoning in every ASK response and reveal the answer in
...
instruction as well as at baseline. Detailed estimates and additional
analyses identifying models from their responses remain in Appendix~\ref{app:prompt-response}.
...
In the paired archive of seven previously tested models, knowing the model improves prediction of giving answers and inviting reasoning under
